...
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair(uint8_t *pk, uint8_t *sk) {
    ...
    PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair_from_seed(seed, pk, sk);
    return 0;
}
...
* Returns 0 (success)
**************************************************/
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair_from_seed(uint8_t *seed, uint8_t *pk, uint8_t *sk) {
